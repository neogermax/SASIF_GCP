/*
 * BGesRrepor0006: Se realiza el paso de informacion desde la tabla de cronoproyec a la de reportes
 *                 para presentar su respectivo grafico. Esto para el reporte numero (90005).
 */
...
public class BGesRepor0006 implements Serializable, ControladorReport {
    ...
    public void cargardatos() {
        ...
        if (bgesReportes.caracteristica != null) { // Si hay un reporte 90005, Actualizar Secuencia
            ...
            try {
                ...
                } else { // si se encuentra consecutivo del reporte 90005 se suma uno
                    bgesReportes.NumMax += 1;
                }
