/*
 * BGesRrepor0002: Se realiza el paso de informacion desde la tabla de cronoproyec a la de reportes
 *                 para presentar su respectivo grafico. Esto para el reporte numero (90001).
 */
...
public class BGesRepor0002 implements Serializable, ControladorReport {
    ...
    public void cargardatos() {
        ...
        if (bgesReportes.caracteristica != null) { // Si hay un reporte 90001, Actualizar Secuencia
            ...
            try {
                ...
                } else { // si se encuentra consecutivo del reporte 90001 se suma uno
                    bgesReportes.NumMax += 1;
                }
