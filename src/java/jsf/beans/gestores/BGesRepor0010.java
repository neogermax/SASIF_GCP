/*
 * BGesRrepor0010: Se realiza la consulta de usuarios por empresa para visualizar su carga de trabajo (90009).
 */
...
public class BGesRepor0010 implements Serializable, ControladorReport {
    ...
    public void cargardatos() {
        ...
        empleados = ptdEmpleados.encontrar(usuario.getEmpleados().getEmpleadosPK());
        
        cronoProye = ptdCronoProye.encontrarProyCro(codcronoproy);
        cronoProMinMax = ptdCronoProye.fechMinMax(codcronoproy);
        usuarios = ptdUsuarios.encontrarPorEmpresa(empleados.getAreas().getEmpresas());
