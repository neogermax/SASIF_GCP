/*
 * BGesRrepor0011: Se realiza la consulta de usuarios por empresa para visualizar su carga de trabajo (90010).
 */
...
public class BGesRepor0011 implements Serializable, ControladorReport {
    ...
    public void cargardatos() {
        ...
        usuarios = ptdUsuarios.encontrarPorArea(empleados.getAreas());
