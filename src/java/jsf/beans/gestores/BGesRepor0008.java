/*
 * BGesRrepor0008: Se realiza el paso de informacion desde la tabla de cronoproyec a la de reportes
 *                 para presentar su respectivo grafico. Esto para el reporte numero (90007).
 */
...
public class BGesRepor0008 implements Serializable, ControladorReport {
    ...
    public void cargardatos() {
        ...
        if (bgesReportes.caracteristica != null) { // Si hay un reporte 90007, Actualizar Secuencia
            ...
            try {
                ...
                } else { // si se encuentra consecutivo del reporte 90007 se suma uno
                    bgesReportes.NumMax += 1;
                }
            ...
            if (cr.getCroproFefRea() != null || cr.getCroproFeiRea() != null)  {
                    for (ProyActs pa : proyActses) {
                        if (pa.getProyActsPK().getPryProCodFk() == codcronoproy && pa.getProyActsPK().getPryActCodFk() == cr.getCronoProyePK().getCroproActCodFk() && pa.getPryUsuSal() != null) {
                            ...
                            sumaPlaneados += Integer.parseInt("" + cr.getCroproCosPla()); //sumatoria planeado.
                            sumaReal += Integer.parseInt("" + cr.getCroproCosRea()); //sumatoria Real
                        }
                    }
            }
        }
